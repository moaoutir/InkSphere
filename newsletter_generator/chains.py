...
prompt_path = os.path.join(settings.BASE_DIR, "newsletter_generator", "shemas", "prompts_templates.yaml")
newsletter_template_path = os.path.join(settings.BASE_DIR, "newsletter_generator", "shemas", "newsletter_template.html")
...
class Chain:
    def __init__(self):
        ...
        self.edit_blog_post_chain = (ChatPromptTemplate.from_messages(
